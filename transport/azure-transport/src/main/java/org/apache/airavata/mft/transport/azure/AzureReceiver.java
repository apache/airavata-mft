...
public class AzureReceiver implements Connector {
    ...
    @Override
    public void init(AuthZToken authZToken,String storageId,   String credentialToken,
                     String resourceServiceHost, int resourceServicePort, String secretServiceHost, int secretServicePort) throws Exception {
