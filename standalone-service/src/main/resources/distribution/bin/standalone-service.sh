...
do
    case ${var} in
        ...
        ;;
        -h)
            echo "Usage: standalone-service.sh"

            echo "command options:"
            echo "  -xdebug             Start MFT Standalone Service under JPDA debugger"
...
java ${JAVA_OPTS} -classpath "${AIRAVATA_CLASSPATH}" \
    org.apache.airavata.mft.standalone.server.StandaloneServiceApplication ${AIRAVATA_COMMAND} $*
